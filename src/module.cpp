...
RCPP_MODULE (VAR_MLP) {
  ...
  class_<CRcppExport> ("VAR_MLP")
        ...
        .method ("train", &CRcppExport::train, "Use the NN to learn from data")
        .method ("forecast", &CRcppExport::forecast, "Provides the predictions of the input data")
    ;
}
...
RCPP_MODULE (CausalityTest) {
 ...
 /*' Class for the non linear Granger CausalityTest. */
