...
double mutualInformation_disc_u (Rcpp::IntegerVector & X,  Rcpp::IntegerVector & Y, std::string log = "log");
double mutualInformation_disc (Rcpp::DataFrame & Df, std::string log = "log");
...
double entropy_cont ( Rcpp::NumericVector & I, int k = 3);
double mutualInformation_cont ( Rcpp::DataFrame & Df, int k = 3, std::string alg = "ksg1");
